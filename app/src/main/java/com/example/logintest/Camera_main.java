...
public class Camera_main extends AppCompatActivity {
    ...
    public void take_an_image(){
        ...
        if (ContextCompat.checkSelfPermission(Camera_main.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Camera_main.this, new String[]{
    ...
    public void upload_an_image(Bitmap captureImage){
        new AlertDialog.Builder(Camera_main.this)
